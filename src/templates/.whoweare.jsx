...
export const WhoWeArePageTemplate = ({ title, content, contentComponent, index, totalCount, transition, image, caption }) => {
	const PageContent = contentComponent || Content;

	return (
		<Page transition={transition} title={title} index={index} totalCount={totalCount} className="section section--gradient-gray">
